...
const handleYesClick = () => {
  question.innerHTML = "LESGOOOOOOOOO JE T'AIME MAISSAAAAA <3333333333";
  ...
  const dateIdeas = [
    "Allons au ski mon amour?",
    "Petite randonnée?",
    "Vamos Deauville !",
    "Go patinoire omg",
    "Date au Louvre ?",
    "Et si on se posait dans un champ pour admirer les étoiles",
    "Date aquarium mon coeur?",
    "Allons acheter nos écharpes corda !",
    "Petite sieste ensemble ?",
    "Soirée lecture avec des bougies à la vanille omg?",
  ...
  letsGoBtn.textContent = "LESGOOOO!!!";
  ...
  letsGoBtn.addEventListener("click", () => {
    ...
    alert(`Idée de date : ${selectedDateIdea}`);
  });
